...
public class AverageCalculatorTask implements Callable<ClimateAverages> {
    ...
    public ClimateAverages call() {
        ...
        return new ClimateAverages(tempAvg, humidityAvg, windSpeedAvg, visibilityAvg, pressureAvg);
    }
}