...
public class YearlyAverageCalculatorTask implements Callable<Map<Integer, Double[]>> {
    ...
    public Map<Integer, Double[]> call() {
        Map<Integer, Double[]> yearlyAverages = new java.util.HashMap<>();
        ...
        for (Map.Entry<Integer, List<ClimateRecord>> entry : dataByYear.entrySet()) {
            ...
            yearlyAverages.put(year, new Double[] {tempAvg, humidityAvg, windSpeedAvg, visibilityAvg, pressureAvg});
        }
